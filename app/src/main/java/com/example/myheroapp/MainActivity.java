...
public class MainActivity extends AppCompatActivity {
    ...
    private void readHeroes() {
        PerformNetworkRequest request = new PerformNetworkRequest(Api.URL_READ_HERO, null, CODE_GET_REQUEST);
        System.out.println(Api.URL_READ_HERO);
        Object x = request.execute();
    ...
    private void deleteHero(int id) {
        String URL = Api.URL_DELETE_HERO + id;
